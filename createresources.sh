...
openstack subnet create --gateway 192.168.1.1 --ip-version 4 --network public_network --allocation-pool start=192.168.40.5,end=192.168.40.10 --no-dhcp --subnet-range 192.168.0.0/16 public_subnet
